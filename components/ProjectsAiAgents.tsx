          ...
          >
            ...
            >
              ...
              <span className="text-foreground">
                o agente para o seu comércio.
              </span>
            </h2>
            <p className="mt-4 max-w-[520px] text-[15px] leading-relaxed tracking-[-0.02em] text-figma-muted">
              Desenhamos o fluxo de conversa, ligamos ao seu sistema de gestão e
              políticas, afinamos respostas para soar como a sua marca — no
              WhatsApp ou no canal que escolher. O resultado é um assistente que
              responde em segundos, 24/7, sem perder o tom do seu negócio.
            </p>
            <ul className="mt-6 space-y-3 text-[14px] font-medium tracking-[-0.01em] text-foreground">
              <li className="flex gap-2">
                ...
                <span>
                  Integração com seu sistema de gestão e horários reais
                </span>
              </li>
              <li className="flex gap-2">
                <span className="text-figma-green" aria-hidden>
                ...
                <span>
                  Treino com o seu vocabulário e regras de atendimento
                </span>
              </li>
              <li className="flex gap-2">
                <span className="text-figma-green" aria-hidden>
